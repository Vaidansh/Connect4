# Name : VAIDANSH KUKREJA       Gnumber: G01512130
import numpy as np
import random
import pygame
import sys
...
BOARD_COLORS = {
	...
	'Shortbread': pygame.Color('#FBE790'),
...
def text_input(title):
	...
	label_font = pygame.font.SysFont("calibri", 34)
	base_font = pygame.font.SysFont("calibri", 30)
	
	text = label_font.render('Enter the player name', True, WHITE, BLACK)
	
	textRect = text.get_rect()
	textRect.topleft = (200, 70)
...
#This function displays time the game lasted and total moves made during the game.
def display_game_stats():

    time_elapsed = (datetime.now() - START_TIME).total_seconds()
    time_elapsed = str(round(time_elapsed, 2))
    ...
    time_font = pygame.font.SysFont("calibri", 36)
    moves_font = pygame.font.SysFont("calibri", 36)
    ...
    time_rect.topleft = (100, 50)
    moves_rect.topleft = (100, 100)
